...
//priority:30000
{
	...
	qff233::GroupMsgEventHandle(e);
	//if (e.message == ".q print") {
	//	e.sendMsg("g_int_anti_often_use_time = " + g_int_anti_often_use_time->toString());
	//	e.message_block();
	//}
	//qff233::RepeatSlt::GetInstance()->run(e);
...
{
	logger.Debug(std::to_string(e.subType));
	if (e.subType == 2) {
		e.pass();
	}
}
